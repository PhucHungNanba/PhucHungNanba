...
aiming to bridge the gap between complex technology and human experience.

**[ Explore My Portfolio](https://github.com/PhucHungNanba/Portfolio)**
...
### Creative Interests
`Multimedia` • `PR` • `Content Creation` • `Streaming` • `Photography` • `Music Theory`
